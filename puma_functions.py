...
def export_to_mysql(dict, E1BSlong,
                    URRlong):  # Exports start and stop positions for each protein etc to a MySQL database
...
def export_from_mysql(choice,
                      accession):  # Exports start and stop positions for each protein etc from a MySQL database
